...
import 'package:awesome_places_app_04/widgets/reusable/shared/button.dart';
import 'package:awesome_places_app_04/widgets/reusable/shared/input.dart';
import 'package:awesome_places_app_04/widgets/reusable/shared/ratings.dart';
          ...
          child: Column(
            children: [
              ...
              const Row(
                ...
                children: [
                  CustomButton(text: "Submit", bgColor: Colors.yellow),
                ],
              ),
              const SizedBox(height: 20),
            ],
